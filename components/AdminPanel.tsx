        ...
        <div className="grid gap-4">
          ...
          <div>
            ...
            <input 
              ...
              onChange={(e) => updateConfig({ identity: { ...config.identity, logoUrl: e.target.value } })}
            />
          </div>
        </div>
      </div>
                 ...
                 <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                        <input 
                            ...
                            onChange={(e) => updateConfig({ header: { ...config.header, textColor: e.target.value } })}
                        />
                        <span className="text-xs text-gray-500">{config.header.textColor}</span>
                    </div>
                 </div>
            </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="grid gap-4">
          ...
          <div>
           ...
           <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Gambar Hero URL</label>
         ...
         <div className="grid gap-4">
          ...
          <div>
            ...
            <input 
              ...
              onChange={(e) => updateConfig({ about: { ...config.about, imageUrl: e.target.value } })}
            />
          </div>
         </div>
      </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <input 
                                    ...
                                    className="w-full p-1.5 border rounded text-xs text-gray-400"
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            <div className="md:col-span-1">
                                ...
                                <input 
                                    ...
                                    value={item.imageUrl}
                                    onChange={(e) => updateNews(item.id, 'imageUrl', e.target.value)}
                                />
                            </div>
